...
type LoopbackRoot struct {
	...
	// LoopbackNode.
	NewNode func(rootData *LoopbackRoot, parent InodeEmbedder, name string, st *syscall.Stat_t) InodeEmbedder
...
func (r *LoopbackRoot) newNode(parent *LoopbackNode, name string, st *syscall.Stat_t) InodeEmbedder {
	if r.NewNode != nil {
...
func (n *LoopbackNode) Lookup(ctx context.Context, name string, out *fuse.EntryOut) (*Inode, syscall.Errno) {
	...
	node := n.RootData.newNode(n, name, &st)
